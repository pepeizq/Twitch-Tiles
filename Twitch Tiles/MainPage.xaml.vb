...
Public NotInheritable Class MainPage
    ...
    Private Sub GridVisibilidad(grid As Grid, tag As String)
        ...
        tbTitulo.Text = "Twitch Tiles (" + SystemInformation.ApplicationVersion.Major.ToString + "." + SystemInformation.ApplicationVersion.Minor.ToString + "." + SystemInformation.ApplicationVersion.Build.ToString + "." + SystemInformation.ApplicationVersion.Revision.ToString + ") - " + tag
    ...
    Private Async Sub LvMasCosasItemClick(sender As Object, args As ItemClickEventArgs)
        ...
        ElseIf sp.Tag.ToString = 5 Then
            ...
            wvMasCosas.Navigate(New Uri("https://github.com/pepeizq/Twitch-Tiles"))
