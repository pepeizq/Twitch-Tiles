...
Public NotInheritable Class MainPage
    ...
    Private Sub Page_Loaded(sender As FrameworkElement, args As Object)
        ...
        AddHandler botonAñadirCarpetaTwitch.PointerEntered, AddressOf UsuarioEntraBoton
        AddHandler botonAñadirCarpetaTwitch.PointerExited, AddressOf UsuarioSaleBoton
        AddHandler botonBorrarCarpetasTwitch.PointerEntered, AddressOf UsuarioEntraBoton
        AddHandler botonBorrarCarpetasTwitch.PointerExited, AddressOf UsuarioSaleBoton
    ...
    Private Sub BotonAñadirCarpetaTwitch_Click(sender As Object, e As RoutedEventArgs) Handles botonAñadirCarpetaTwitch.Click
